...
Recently shipped a similar multi-tenant SaaS (DealerHub) managing 187+ vehicles with role-based access across multiple dealership accounts.

Are you planning fixed RBAC roles (Admin/Viewer) or do teams need configurable permission sets per module?

The demo covers the core flow — want to discuss what the production version needs beyond this?
